...
func InitDB() {
	...
	orm.RegisterDataBase("default", "postgres", "user=postgres password=admin host=127.0.0.1 port=5432 dbname=user_database sslmode=disable")
	orm.RegisterModel(new(UserDataTable))
